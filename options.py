'python train.py --extralayers 1 --nz 500 --ngf 96 --ndf 96 --save_image_freq 50 --save_test_images --niter 500 --lr 0.00006 --beta1 0.38 --w_adv 0.6 --w_con 90 --w_enc 2 --display -- batchsize 16'
""" Options
...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--proportion', type=float, default=0.5, help='Proportion of anomalies in test set.')
        self.parser.add_argument('--metric', type=str, default='RGB', help='Evaluation metric.')
        ...
        self.parser.add_argument('--save_evalRGB_freq', type=int, default=30, help='frequency of saving ROC-curve')
